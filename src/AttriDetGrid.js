...
import { faMinus, faPlus,faFloppyDisk,faPrint,faBars, faListUl } from '@fortawesome/free-solid-svg-icons';
  ...
  const handleSearch = async () => {
    try {
      const response = await fetch(`${config.apiBaseUrl}/getattributeSearchdata`, {
        ...
        body: JSON.stringify({ attributeheader_code, attributedetails_code, attributedetails_name, descriptions }) // Send as search criteria
      });
